...
import type { PanelGroupHandle, PanelHandle } from "@window-splitter/interface"
import type { PercentUnit } from "@window-splitter/state"

export default {
	title: "External/WindowSplitter",
}
...
export function Collapsible({
	...
	return (
		<StyledPanelGroup handle={handle} autosaveId="test">
			<StyledPanel
...
export function CollapsibleVertical({
	topPanelHandle,
	bottomPanelHandle,
	handle,
}: {
	topPanelHandle?: React.Ref<PanelHandle>
	handle?: React.Ref<PanelGroupHandle>
	bottomPanelHandle?: React.Ref<PanelHandle>
}) {
	const [collapsed, setCollapsed] = React.useState(true)
...
export function NestedCollapsibleVertical({
	topPanelHandle,
	bottomPanelHandle,
	handle,
}: {
...
export function CollapsibleVerticalStatic({
	topPanelHandle,
	bottomPanelHandle,
	handle,
}: {
